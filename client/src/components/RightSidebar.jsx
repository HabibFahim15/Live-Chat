...
const RightSidebar = ({ selectedUser }) => {
  return (
    selectedUser && (
      <div
        className={`bg-[#8185B2]/10 text-white w-full
      ...
      >
        ...
        items-center gap-2 text-xs font-light mx-auto"
        >
          <img
        ...
        <div className="px-5 text-xs">
          <p>Media</p>
          <div
            className="mt-2 max-h-[200px] overflow-y-scroll no-scrollbar
        ...
        <button
          className="absolute bottom-5 left-1/2 transform -translate-1/2 
